...
You will be given a list of contract clauses. Your task is to meticulously review each clause and categorize it based on its potential risk level for a party signing the agreement.
...
For each clause you identify, you must place it into the appropriate risk category array in the output format.

Analyze the following clauses:
{{#each clauses}}
  - Title: {{{this.title}}}
    Text: {{{this.text}}}
{{/each}}
